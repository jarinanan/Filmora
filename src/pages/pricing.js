  ...
  return (
    <div className="relative isolate bg-gray-950 px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-2 text-5xl font-semibold tracking-tight text-balance text-aqua sm:text-6xl">
          Choose the right plan for you
        </p>
      </div>
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-gray-300 sm:text-xl/8">
      Choose an affordable plan packed with the best features for an immersive viewing experience, unlimited entertainment, and seamless streaming.
      </p>
